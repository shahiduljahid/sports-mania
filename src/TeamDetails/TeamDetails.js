...
const TeamDetails = () => {
  ...
  const { strCountry, strDescriptionEN, strLeague, strBanner, strBadge,strGender,intFormedYear,strSport,strTwitter,strWebsite,strYoutube } = team;
  ...
  return (
    <div className="teamInfo">
      ...
      <div className="container">
        ...
        <Link className="web" to={`${strWebsite}`}><FontAwesomeIcon icon={faGlobe} /></Link>
        <Link  className="twitter" to={`${strYoutube}`}><FontAwesomeIcon icon={faTwitterSquare} /></Link>
        <Link  className="youtube" to={`${strTwitter}`}><FontAwesomeIcon icon={faYoutube} /></Link>
        </div>
